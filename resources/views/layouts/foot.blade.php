...
<script src="{{ asset('js') }}/object-fit.js"></script>

<script src="{{ asset('js') }}/custom/cosyalert/ga.js"></script>
<script src="{{ asset('js') }}/cosyalert/ca-pub-2783044520727903.js"></script> 
